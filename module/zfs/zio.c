...
/*
 * This function is used for both ZIO_STAGE_ENCRYPT_DDT and ZIO_STAGE_ENCRYPT.
 * It is responsible for managing the storage of encryption parameters and
 * passing them to the lower-level encryption fucntions.
 */
static int
